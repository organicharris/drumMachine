const bankA = [
    ...
    {sampleID: 'Open Hat', url: "https://staticserver.craigharrison.dev/drumMachineSamples/openHat.mp3"}, 
    {sampleID: 'Snare', url: "https://staticserver.craigharrison.dev/drumMachineSamples/snare.mp3"}, 
    {sampleID: 'Rimshot', url: "https://staticserver.craigharrison.dev/drumMachineSamples/rimshot.mp3"}, 
    {sampleID: 'High Conga', url: "https://staticserver.craigharrison.dev/drumMachineSamples/highConga.mp3"},  
    {sampleID: "Low Conga", url: "https://staticserver.craigharrison.dev/drumMachineSamples/lowConga.mp3"}, 
