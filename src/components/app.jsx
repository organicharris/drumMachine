                    ...
                    <div id="controls">
                        <div id="pads">
                            ...
                            <button className={this.state.buttonQ} id="padQ" type="button" onClick={this.padTrigger} value="Q">
                                ...
                                <audio src={bankA[1].url} id="bank-A-Q" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[1].url} id="bank-B-Q" type="audio/mpeg" preload="auto"></audio>
                            </button>
                            <button className={this.state.buttonW} id="padW" type="button" onClick={this.padTrigger} value="W">
                                ...
                                <audio src={bankA[2].url} id="bank-A-W" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[2].url} id="bank-B-W" type="audio/mpeg" preload="auto"></audio>
                            </button>
                            <button className={this.state.buttonE} id="padE" type="button" onClick={this.padTrigger} value="E">
                                ...
                                <audio src={bankA[3].url} id="bank-A-E" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[3].url} id="bank-B-E" type="audio/mpeg" preload="auto"></audio>
                            </button>
                            <button className={this.state.buttonA} id="padA" type="button" onClick={this.padTrigger} value="A">
                                ...
                                <audio src={bankA[4].url} id="bank-A-A" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[4].url} id="bank-B-A" type="audio/mpeg" preload="auto"></audio>
                            </button>
                            <button className={this.state.buttonS} id="padS" type="button" onClick={this.padTrigger} value="S">
                                ...
                                <audio src={bankA[5].url} id="bank-A-S" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[5].url} id="bank-B-S" type="audio/mpeg" preload="auto"></audio>
                            </button>
                            <button className={this.state.buttonD} id="padD" type="button" onClick={this.padTrigger} value="D">
                                ...
                                <audio src={bankA[6].url} id="bank-A-D" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[6].url} id="bank-B-D" type="audio/mpeg" preload="auto"></audio>
                            </button>
                            <button className={this.state.buttonZ} id="padZ" type="button" onClick={this.padTrigger} value="Z">
                                ...
                                <audio src={bankA[7].url} id="bank-A-Z" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[7].url} id="bank-B-Z" type="audio/mpeg" preload="auto"></audio>
                            </button>
                            <button className={this.state.buttonX} id="padX" type="button" onClick={this.padTrigger} value="X">
                                ...
                                <audio src={bankA[8].url} id="bank-A-X" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[8].url} id="bank-B-X" type="audio/mpeg" preload="auto"></audio>
                            </button>
                            <button className={this.state.buttonC} id="padC" type="button" onClick={this.padTrigger} value="C">
                                ...
                                <audio src={bankA[9].url} id="bank-A-C" type="audio/mpeg" preload="auto"></audio>
                                <audio src={bankB[9].url} id="bank-B-C" type="audio/mpeg" preload="auto"></audio>
                            </button>
                        </div>
                        <div id="master">
                            <div id="volumeSlider">
